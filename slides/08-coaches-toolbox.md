---
title: Coaches' Toolbox | Practical Session Resources
layout: section
---
...
<div class="grid grid-cols-2 gap-6 mt-8">
  ...
  <TakeawayBox title="Formats & Goal Sizes" type="info">
    <b>4v4 (U6–U7):</b> 4 x 6 ft goals, size 3 ball. No real keeper role; everyone rotates.<br/><br/>
    <b>7v7 (U8–U10):</b> 7 x 21 ft goals, size 4 ball. First keeper turns; goal small enough to feel safe.<br/><br/>
    <b>9v9 (U11–U12):</b> 7 x 21 ft goals, size 4 ball. Full technical base; angles and 1v1 begin.<br/><br/>
...
```mermaid {theme: 'base', scale: 0.6}
flowchart TD
    A[Goal Conceded] --> B[3-Second Pause]
    B --> C[One Forward Cue]
    C --> D[Keeper Reorganizes or Resets]
    D --> E[Next Save Praised]
```
...
```mermaid {theme: 'base', scale: 0.6}
flowchart TD
    A[Team Warm-Up] --> B[Keeper Block]
    B --> C[Team Game From GK]
    C --> D[One Cool Save Recap]
```
