...
<template>
  ...
  >
    ...
    <!-- Optional full-width default slot -->

    <div v-if="$slots.default" class="w-full h-fit flex-shrink-0 px-8">
      <div class="slidev-layout default w-full m-0" style="padding-bottom: 0 !important;">
        <slot name="default" />
      </div>
    </div>
