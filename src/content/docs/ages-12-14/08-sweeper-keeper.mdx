...
<CardGrid>
  <Card icon="compass" title="1. Spatial Tethering">
    **"Tether to the Line"**
  ...
  <Card icon="eye" title="2. Reading the Trigger Foot">
    **"Watch the Wind-Up"**
  ...
  <Card icon="microphone" title="3. Pre-Emptive Field Voice">
  ...
  <Card icon="shield" title="4. Clearance Decision-Making">
    **"Clear or Keep"**
