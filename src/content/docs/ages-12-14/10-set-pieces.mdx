...
<CardGrid>
  <Card icon="right-arrow" title="1. Corner Kick Positioning">
    **"Read the Curve"**
  ...
  <Card icon="star" title="2. Dynamic Wall Architecture">
    **"Sight the Near Post"**
  ...
  <Card icon="magnifier" title="3. Penalty Kick Stance & Read">
    **"Hold & React"**
  ...
  <Card icon="comment" title="4. Zonal & Man-Marking Directives">
    **"Assign the Space"**
